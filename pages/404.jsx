    ...
    return (
        ...
        >
            <div className="flex h-screen flex-col items-center  text-center p-3 pt-10 space-y-3">
                ...
                <Image src={'https://jiale.imglab-cdn.net/loading.png?format=avif'} alt={'404'} width={270} unoptimized={true} height={250} className={'rounded-md mt-2'}/>
                ...
                <button
                    onClick={() => router.push('/')}
                    className="mt-6 inline-block rounded-xl cursor-pointer bg-black px-6 py-2 text-white hover:bg-gray-800 dark:hover:bg-gray-950 transition"
                >
                    Go Home
                </button>
            </div>
